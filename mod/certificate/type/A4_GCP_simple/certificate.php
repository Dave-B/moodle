...
// Oxford logo
    $imgwidth = 78;
    $imgheight = 24;
    $imgleftpos = ($brdrw - $imgwidth)/2;
    $pdf->Image("$CFG->dirroot/mod/certificate/type/A4_oxford_logo_2012/ox_small_blue_pos_rect.png", $imgleftpos, 30, $imgwidth, $imgheight);
    //$pdf->Image("$CFG->dirroot/mod/certificate/type/A4_oxford_logo_2012/ox_brand_cmyk_pos_rect.eps", $imgleftpos, 30, $imgwidth, $imgheight);

// Add text
    $pdf->SetTextColor(0,33,71);
    cert_printtext($x, $y+42, 'C', 'Helvetica', '', 25, get_string('certify', 'certificate'));
    $pdf->SetTextColor(0,0,0);
    cert_printtext($x, $y+64, 'C', 'Helvetica', '', 20, $studentname);
    $pdf->SetTextColor(0,33,71);
    cert_printtext($x, $y+85, 'C', 'Helvetica', '', 25, get_string('statementundertakengcp', 'certificate'));
    $pdf->SetTextColor(0,0,0);
    cert_printtext($x, $y+102, 'C', 'Helvetica', '', 20, $classname);
    cert_printtext($x, $y+122, 'C', 'Helvetica', '', 14, $certificatedate);
    cert_printtext($x, $y+132, 'C', 'Times', '', 10, $grade);
    cert_printtext($x, $y+142, 'C', 'Times', '', 10, $outcome);
    cert_printtext($x, $y+152, 'C', 'Times', '', 10, $credithours);
