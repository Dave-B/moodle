...
// Add text
    cert_printtext($x, $y+42, 'C', 'Helvetica', '', 20, get_string('certify', 'certificate'));
    $pdf->SetTextColor(0,33,71);
    cert_printtext($x, $y+64, 'C', 'Helvetica', '', 25, $studentname);
    $pdf->SetTextColor(0,0,0);
    cert_printtext($x, $y+85, 'C', 'Helvetica', '', 20, get_string('statementundertaken', 'certificate'));
    $pdf->SetTextColor(0,33,71);
    cert_printtext($x, $y+102, 'C', 'Helvetica', '', 25, $classname);
    $pdf->SetTextColor(0,0,0);
