...
$string['auth_ldap_rolen'] = 'Role {$a}';
$string['auth_ldap_rolen_help'] = 'Moodle role to assign to users with corresponding LDAP context.';
$string['auth_ldap_rolencontext'] = 'Role {$a} context';
$string['auth_ldap_rolencontext_help'] = 'LDAP context used to select for corresponding system role assignment.';
...
$string['systemrolesmapping'] = 'System roles mapping';
