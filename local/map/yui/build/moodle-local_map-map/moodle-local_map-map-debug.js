        ...
        if (err) {
            ...
            Y.Get.js('http://cdn.leafletjs.com/leaflet-0.6.4/leaflet.js', function (err) {
                if (err) {
                    ...
                    NS.L = L;
                    NS.maps = {};
                    Y.log('moodle-local_map-map: Leaflet initialised');
        ...
        on : {
            success : function (tx, r) {
                ...
                try {
                    ...
                    Y.log(error, 'reversegeocode: JSON Parse failed', 'moodle-local_map-map'); // TODO Check/correct this use of error logging
                    return;
                }
            },
            failure : function () {
                Y.log(error, 'reversegeocode: Lookup failed', 'moodle-local_map-map');
            }
        }
    });
};
