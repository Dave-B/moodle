 ...
 */
function callback_topicstall_uses_sections() {
    return true;
}
 ...
 * @return string
 */
function callback_topicstall_definition() {
    return get_string('topic');
}

function callback_topicstall_get_section_name($course, $section) {
 ...
 * @return stdClass
 */
function callback_topicstall_ajax_support() {
 ...
 */
function callback_topicstall_ajax_section_move($course) {
    global $COURSE, $PAGE;
